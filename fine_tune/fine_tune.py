...
def objective(trial: optuna.trial.Trial) -> float:
    ...
    beta = trial.suggest_categorical("beta", [2.0, 2.5, 3.0])

    model_conf['l1_in'] = trial.suggest_categorical('l1_in', [64, 128, 192, 256])

    model_conf['actor_l2_in'] = trial.suggest_categorical('actor_l2_in', [64, 128, 192, 256, 512])
    ...
    model_conf['critic_l2_in'] = trial.suggest_categorical('critic_l2_in', [64, 128, 192, 256, 512])
    ...
    subprocess.run(['python3', path + '/../test/markov_app/ac_policy.py'], check=True)
